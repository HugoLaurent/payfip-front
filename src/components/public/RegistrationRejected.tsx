...
export function RegistrationRejected({
  ...
  return (
    ...
    >
      <div className="flex h-[78px] w-[78px] items-center justify-center rounded-full bg-[oklch(0.96_0.03_35)] text-[30px] font-bold text-aregie-coral">
        !
      </div>
      <div>
      ...
      {rejectionReason && (
        <div className="squircle w-full rounded-[16px] bg-[oklch(0.96_0.02_265)] px-4 py-[14px] text-left">
